                ...
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <form class="form" method="post" action="{{route('admin.assign.subjects.update', $id)}}">
                                @csrf
                                <div class="box-body">
                                    <div class="add_item">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="class_id" style="width: 100%;">
                                                @foreach($classes as $class)
                                                    <option value="{{ $class->id }}" {{ $class->id == $id ? 'selected' : '' }}>{{ $class->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="full_mark[]" class="form-control" value="{{ $row->full_mark }}">
                                                    @error('full_mark')
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pass_mark[]" class="form-control" value="{{ $row->pass_mark }}">
                                                    @error('pass_mark')
                                                    <span class="text-danger"> {{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="subjective_mark[]" class="form-control" value="{{ $row->subjective_mark }}">
