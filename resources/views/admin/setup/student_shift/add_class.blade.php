                ...
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <form class="form" method="post" action="{{route('admin.shifts.store')}}">
                                @csrf
                                <div class="box-body">
                                    ...
                                    <hr class="my-15">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control" placeholder="Add Shift Name" value="{{ old('name') }}">
                                            @error('name')
                                ...
                                <div class="box-footer">
                                    ...
                                    <input type="submit" class="btn btn-rounded btn-primary btn-outline" name="addShift" value="Add Shift"/>
                                </div>
                            </form>
                        </div>
                        <!-- /.box -->
